    ...
    \begin{center}
      \ifGDShowHeaderQR
        \ifstrempty{\GD@ExamQR}{}{%
          \includegraphics[width=\GDQRWidth]{\GD@ExamQR}%
        }
      \fi
    \end{center}
  \end{minipage}
...
\newcommand{\GDIfEqIgnoreCase}[4]{%
  ...
  \ifstrequal{\GDTempA}{\GDTempB}{\endgroup#3}{\endgroup#4}%
}

\newcommand{\GDChoiceItem}[3]{%
  % #1 = choice letter (A/B/C/D)
  % #2 = displayed text
  % #3 = optional correct letter
  \IfNoValueTF{#3}{%
    \textbf{#1.}~#2%
  }{%
    \ifshowanswers
      \GDIfEqIgnoreCase{#1}{#3}{%
        \AnswerHighlight{\textbf{#1.}~#2}%
      }{%
        \textbf{#1.}~#2%
      }%
    \else
...
\NewDocumentCommand{\ChoicesOneLine}{m m m m g}{%
  ...
  \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X@{\hspace{\GDExamChoiceSep}}>{\raggedright\arraybackslash}X@{\hspace{\GDExamChoiceSep}}>{\raggedright\arraybackslash}X@{\hspace{\GDExamChoiceSep}}>{\raggedright\arraybackslash}X@{}}
    \GDChoiceItem{A}{#1}{#5} & \GDChoiceItem{B}{#2}{#5} & \GDChoiceItem{C}{#3}{#5} & \GDChoiceItem{D}{#4}{#5}
  \end{tabularx}
  \par
}

% 2 choices per line, 2 lines, optional answer letter as 5th braced arg
\NewDocumentCommand{\ChoicesTwoLines}{m m m m g}{%
  \par\ResetExamChoices
  \noindent
  \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X@{\hspace{\GDExamChoiceSep}}>{\raggedright\arraybackslash}X@{}}
    \GDChoiceItem{A}{#1}{#5} & \GDChoiceItem{B}{#2}{#5} \\[\GDExamChoiceRowSep]
    \GDChoiceItem{C}{#3}{#5} & \GDChoiceItem{D}{#4}{#5}
  \end{tabularx}
  \par
}

% 1 choice per line, 4 lines, optional answer letter as 5th braced arg
\NewDocumentCommand{\ChoicesFourLines}{m m m m g}{%
  \par\ResetExamChoices
  \noindent
  \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X@{}}
    \GDChoiceItem{A}{#1}{#5} \\[\GDExamChoiceRowSep]
    \GDChoiceItem{B}{#2}{#5} \\[\GDExamChoiceRowSep]
    \GDChoiceItem{C}{#3}{#5} \\[\GDExamChoiceRowSep]
    \GDChoiceItem{D}{#4}{#5}
  \end{tabularx}
  \par
}
